...
<head>
  ...
  <title>「
    <?php echo $this->currentTagName;?>」の記事｜
...
<div id="wrapper">
  ...
  <div class="contents_inner cf">
    ...
    <h1 class="blogtitle01">タグ：「<?php echo $this->currentTagName;?>」の記事（<?php echo $this->currentTagCount;?>件）</h1>
      ...
      <div class="archivelist">
        <div class="list tag">
          ...
          <?php if ($tag['current']) : ?>
          <a class="current" href="<?php echo $tag['blogArchivesTagUrl'];?>">
            <?php echo $tag['blogTagName'];?>
          </a>
          <?php else:?>
          <a href="<?php echo $tag['blogArchivesTagUrl'];?>">
            <?php echo $tag['blogTagName'];?>
          </a>
          <?php endif;?>
          <?php endforeach;?>
