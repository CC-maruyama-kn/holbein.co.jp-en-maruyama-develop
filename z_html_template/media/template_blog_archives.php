...
<head>
  ...
  <title>
    <?php echo $this->currentYear;?>年
    <?php echo $this->currentMonth;?>月の記事｜
...
<body>
  ...
  <div id="contents" class="clearfix">
    ...
    <h1 class="blogtitle01"><?php echo $this->currentYear;?>年
        <?php echo $this->currentMonth;?>月の記事（
        <?php echo $this->currentMonthCount;?>件）</h1>
      ...
      <div class="archivelist">
        <div class="list year">
          ...
          <?php if ($year['current']) : ?>
          <a class="current" href="<?php echo $year['blogArchivesYearUrl'];?>">
            <?php echo $year['year'];?>年</a>
          <?php else:?>
          <a href="<?php echo $year['blogArchivesYearUrl'];?>">
            <?php echo $year['year'];?>年</a>
          <?php endif;?>
          <?php endforeach;?>
        </div>
        <div class="list manth">
          ...
          <a class="current" href="<?php echo $month['blogArchivesMonthUrl'];?>">
            <?php echo $month['month'];?>月(
            <?php echo $month['count'];?>)</a>
          <?php else:?>
          <a href="<?php echo $month['blogArchivesMonthUrl'];?>">
            <?php echo $month['month'];?>月(
            <?php echo $month['count'];?>)</a>
          <?php endif;?>
          <?php endforeach;?>
