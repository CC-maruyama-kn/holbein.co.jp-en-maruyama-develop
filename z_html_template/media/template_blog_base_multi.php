...
<head>
  ...
  <title>
    <?php echo $this->req['folderNavi'][-1]['contentsName']; ?>｜
    <?php echo $this->metaTitle;?>
  </title>
  <meta name="keywords" content="<?php echo $this->metaKeyword;?>">
  <meta name="description" content="<?php echo $this->metaDescription;?><?php echo $this->currentTagDescription;?>">
  ...
  <div class="contents_inner cf">
    ...
    <div id="contents_left">
      ...
      <div id="dcms_layoutPageBlockPasteArea">
        ...
        <h1 class="blogtitle01"><?php echo $this->req['folderNavi'][-1]['contentsName']; ?></h1>
        
        <div class="desbox">
        <?php echo $this->currentTagDescription;?>
         </div>
          <!-- 新しい順古い順-st -->
