...
$(function(){
    $("dl:nth-child(odd)").css("background-color","#EFF0F3");
});
// --></script>
...
<?php if( $this->req['contentsFormInfo']['htmlEditFlg'] == 1 ){ ?>
...
?>
<p class="iphone_nobr mt10"><a class="txtLink" href="http://www.startialab.co.jp/policy/privacy.html" target="_blank">個人情報保護方針</a>、<a class="txtLink" href="http://www.startialab.co.jp/policy/handling.html" target="_blank">個人情報の取扱いについて</a></p>
...
<div style=" clear:both; width:690px; border: 1px dotted #CCCCCC;padding: 15px;" class="clear border_box mt20">
<p>このメールフォームは個人情報保護のためSSL暗号化通信により保護しており、情報の改ざん・漏えいなどの危険から守られ、安全に通信することが出来ます。</p>
</div>
