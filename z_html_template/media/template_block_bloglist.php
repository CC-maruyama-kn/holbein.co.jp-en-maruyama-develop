...
<li><a href="<?php echo $post['blogPostUrl'];?>">
  <figure class="reco_thumbnail"><img src="<?php echo $post['blogCoverImageUrl'];?>" alt="<?php echo $post['blogSubject'];?>" alt="<?php echo $post['blogSubject'];?>" /></figure>
  <p class="info"><?php echo $post['blogSubject'];?></p>
  </a> </li>
<?php endforeach;?>
<?php else:?>
<?php /* 記事タイトルのみ最新N件を表示 */?>
...
<div class="blog_section01">
  <div class="blog_article01"> <span class="blog_date01"><?php echo $post['blogPublishDate_YMD'];?></span>
    <h4 class="blog_subtitle02"> <?php echo $post['blogSubject'];?> </h4>
