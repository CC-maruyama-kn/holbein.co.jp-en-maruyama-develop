...
<li>
      <div class="contest_kakosakuhin_img"><a href="<?php echo $post['blogPostUrl'];?>"><img title="<?php echo $post['blogSubject'];?>" src="<?php echo $post['blogCoverImageUrl'];?>" alt="<?php echo $post['blogSubject'];?>" data-popupalt-original-title="null" /></a></div>
      <div class="flt contest_kakosakuhin_data"><?php echo $post['blogPublishDate_YMD'];?></div>
      <?php foreach ($post['blogCategory'] as $category):?><div class="flr contest_kakosakuhin_cate01"><?php echo $category['blogCategoryName'];?></div><?php endforeach;?>
      <p class="clear"><?php echo $post['blogSubject'];?></p>
    </li>
