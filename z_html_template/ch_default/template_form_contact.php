...
<script type="text/javascript" src="<?php echo $shareSslSiteRoot;?>/dcms_public/js/jquery-1.7.2/plugin/jquery.validationEngine-en-en.js" charset="utf-8"></script>
...
<?php 
    ...
    if ($this->mode == cmnConst::MODE_CONFIRM) {
?>
<div class="contact_confirmation">Please click a submit button, if contents written by you are right.</div>
<?php 
    // 入力時
    } else {
?>
<div id="form_intro"><?php echo nl2br($this->req['contentsFormInfo']['topDescription']);?></div>
<div id="form_required_text">Fill in the blanks.<br /><strong>※</strong>Your name and email address are necessary to be filled.</div>
<?php 
    }
?>
...
?>
<div id="submit_button"><input value="Submit" type="submit" /></div>
<?php 
        }
    }
?>
