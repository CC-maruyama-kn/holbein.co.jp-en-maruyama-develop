...
<dl class="<?php echo $errClass;?>">
<dt><?php echo nl2br($val['elementName']) . $requiredStr;?></dt>
<dd>姓 <input type="text" name="<?php echo $inputName . 'SeiKana';?>" id="<?php echo $inputName . 'SeiKana';?>" value="<?php echo $this->req[$inputName . 'SeiKana'];?>" class="family_name_yomi<?php echo $requiredClass;?>" /> 名 <input type="text" name="<?php echo $inputName . 'MeiKana';?>" id="<?php echo $inputName . 'MeiKana';?>" value="<?php echo $this->req[$inputName . 'MeiKana'];?>" class="first_name_yomi<?php echo $requiredClass;?>" />
<?php echo $inputExampleStr;?>
<?php echo $errText;?>
</dd>
</dl>
