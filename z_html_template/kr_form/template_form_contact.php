...
<?php 
    ...
    if ($this->mode == cmnConst::MODE_CONFIRM) {
?>
<div id="form_intro">다음의 내용으로 괜찮 으시면 전송 버튼을 클릭하십시오.</div>
...
※고객님의 개인정보를 제3자에게 공개하거나 또는 다른 목적으로 사용하지 않습니다.<br />
※성명과 메일 주소는 입력 필수 항목입니다.<br />
<strong>※문의는 일본어 또는 영어만 접수하고 있습니다.</strong>
</div>
<?php 
    }
?>
...
<?php 
        if ($this->mode == cmnConst::MODE_CONFIRM) {
?>
<div id="submit_button"><input value="돌아간다" type="button" onClick="document.getElementById('mode').value='';document.getElementById('contact-form').submit();" />&nbsp;&nbsp;<input value="송신" type="submit" /></div>
<?php 
        } else {
?>
<div id="submit_button"><input value="송신" type="submit" /></div>
<?php 
        }
    }
?>
