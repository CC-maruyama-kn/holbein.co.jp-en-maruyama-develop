...
<?php 
    ...
    if ($this->mode == cmnConst::MODE_CONFIRM) {
?>
<div id="form_intro">Por favor, haga clic en el botón enviar.</div>
...
*Sus datos personales no pasarán a terceros ni se utilizarán para otros fines.<br />
※Su nombre y dirección de correo electrónico son campos obligatorios.<br />
<strong>※Por favor, introduzca el japonés o Inglés.</strong>
</div>
<?php 
    }
?>
...
<?php 
        if ($this->mode == cmnConst::MODE_CONFIRM) {
?>
<div id="submit_button"><input value="Retorno" type="button" onClick="document.getElementById('mode').value='';document.getElementById('contact-form').submit();" />&nbsp;&nbsp;<input value="Enviar" type="submit" /></div>
<?php 
        } else {
?>
<div id="submit_button"><input value="Enviar" type="submit" /></div>
<?php 
        }
    }
?>
