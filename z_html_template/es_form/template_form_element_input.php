...
<dl>
<dt><?php echo nl2br($val['elementName']) . $requiredStr;?></dt>
<dd>한자 <input type="text" name="<?php echo $inputName . 'SeiKana';?>" id="<?php echo $inputName . 'SeiKana';?>" value="<?php echo $this->req[$inputName . 'SeiKana'];?>" class="family_name_yomi<?php echo $requiredClass;?>" /> 읽는 법 <input type="text" name="<?php echo $inputName . 'MeiKana';?>" id="<?php echo $inputName . 'MeiKana';?>" value="<?php echo $this->req[$inputName . 'MeiKana'];?>" class="first_name_yomi<?php echo $requiredClass;?>" />
...
<?php
        ...
        echo $this->formSelectExt($inputName . 'Addr1', $this->req[$inputName . 'Addr1'], 
                                 ...
                                 $aryPref, cmnConst::REQUIRED_OFF, 'Please choose');
?>
...
<?php 
    echo $this->formSelectExt($inputName, $this->req[$inputName], 
                             array('class' => $requiredClass), 
                             $arySelectValue, cmnConst::REQUIRED_OFF, 'Please choose');
?>
<?php echo $inputExampleStr;?>
<?php echo $errText;?>
</dd>
