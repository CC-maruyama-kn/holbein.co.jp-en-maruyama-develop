...
<title><?php echo $this->currentYear;?>年<?php echo $this->currentMonth;?>月の記事 -<?php echo $this->blogSettings['blogName'];?></title>
...
<meta property="og:title" content="<?php echo $this->currentYear;?>年<?php echo $this->currentMonth;?>月の記事 - <?php echo $this->blogSettings['blogName'];?>">
...
<?php endif; ?>
</head><body class="common">
<?php echo $this->snsTagScript . PHP_EOL;?><!--header st--> 
...
<!--locator end--> <div id="contents_left"> <!-- ブロック貼り付けエリア -->
<div id="dcms_layoutPageBlockPasteArea"> 
<!-- ブロック -->
<div id="dcms_layoutPageBlock">
<div class="blog_section02">
<h3 class="subtitle03"> <?php echo $this->blogSettings['blogName'];?> <span class="blog_subtext01"><?php echo $this->blogSettings['blogSubName'];?></span> </h3><!--タグリスト st--> 
...
<?php endif;?>
<!--タグリスト end--> <!--年月リスト st--> 
<?php if (count($this->yearList) > 0) : ?>
<div class="blog_archive_list_box01">
<ul class="blog_list">
<?php foreach ($this->yearList as $year):?>
<?php if ($year['current']) : ?>
<li class="current"><a href="<?php echo $year['blogArchivesYearUrl'];?>"><?php echo $year['year'];?>年</a></li>
<?php else:?>
<li><a href="<?php echo $year['blogArchivesYearUrl'];?>"><?php echo $year['year'];?>年</a></li>
<?php endif;?>
<?php endforeach;?>
</ul>
<ul class="blog_month_list">
<?php foreach ($this->monthList as $month):?>
<?php if ($month['current']) : ?>
<li class="current"><a href="<?php echo $month['blogArchivesMonthUrl'];?>"><?php echo $month['month'];?>月(<?php echo $month['count'];?>)</a></li>
<?php else:?>
<li><a href="<?php echo $month['blogArchivesMonthUrl'];?>"><?php echo $month['month'];?>月(<?php echo $month['count'];?>)</a></li>
<?php endif;?>
<?php endforeach;?>
</ul>
</div>
<?php endif;?>
<!--年月リスト end--> <h4 class="subtitle04"><?php echo $this->currentYear;?>年<?php echo $this->currentMonth;?>月</strong>の記事（<?php echo $this->currentMonthCount;?>件）</h4><!--新しい古い順 st--> 
