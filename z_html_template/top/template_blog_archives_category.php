...
<!-- ブロック -->
<div id="dcms_layoutPageBlock"><div class="blog_section02"><h3 class="subtitle03"> <?php echo $this->blogSettings['blogName'];?> <span class="blog_subtext01"><?php echo $this->blogSettings['blogSubName'];?></span> </h3>
<!--カテゴリ リスト st--> 
...
<?php endif;?>
<!--カテゴリ リスト end--> <h4 class="subtitle04">カテゴリ：<strong>「<?php echo $this->currentCategoryName;?>」</strong>の記事（<?php echo $this->currentCategoryCount;?>件）</h4>
<!--新しい古い順 st--> 
...
<?php endif;?>
<!--カバー写真 end--> <div class="blog_article01">
<!--日付 st-->
<time class="blog_date01"><?php echo $post['blogPublishDate_YMD'];?></time>
<!--日付 end-->
<h4 class="blog_subtitle02"> <a href="<?php echo $post['blogPostUrl'];?>"><?php echo $post['blogSubject'];?></a> </h4><!--sns st-->
